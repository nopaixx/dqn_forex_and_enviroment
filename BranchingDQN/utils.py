...
#class TensorEnv(gym.Wrapper): 
    ...
    def __init__(self, env_name, _low,_min): 

        self.env = Environment(_low,_min)
    ...
    def step(self, a): 
        ...
        return self.process(ns), r, done,_


class BranchingTensorEnv(TensorEnv): 

    def __init__(self, env_name, n, _low,_min): 

        super().__init__(env_name, _low,_min)
        self.n = n 
